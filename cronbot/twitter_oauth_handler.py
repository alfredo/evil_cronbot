"""
Original at: https://github.com/tav/tweetapp
...
def get_cronbot_token():
    """Returns the token for evil_cronbot"""
    token_list = db.GqlQuery("SELECT * "
                             "FROM OAuthAccessToken "
                             "WHERE specifier = 'evil_cronbot'")
    try:
        return token_list[0]
    except IndexError:
        pass
    # TODO: regenerate the previous token
    return None
...
class OAuthClient(object):
    ...
    def get_cookie(self):
        #self.handler.request.cookies.get('oauth.%s' % self.service, '')
        return 'id-3728c605-aba8-4f72-b2cf-600087e43cd6'
